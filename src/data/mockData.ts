...
export const LEADS: Lead[] = [
  ...
  { id: 'l30', companyName: 'Bagel Brigade', title: 'Payroll & Compliance, HR Setup – QSR Startup', contactPerson: 'Sharath Chandra Reddy Gattu', linkedin: 'https://in.linkedin.com/company/bagel-brigade-india', requirement: 'Payroll & Compliance, HR Setup', location: 'Hyderabad / Remote', stage: 'New', temperature: 'Hot', source: 'Indeed', value: 17500, probability: 40, assignedTo: 'Annu Sharma', expectedCloseDate: '2026-06-30', notes: "Remote engagement. ₹15–20k/mo. Via Indeed. India's first NYC-style Bagels & Coffee QSR. Jubilee Hills, Hyderabad. Founder: Sharath Chandra Reddy Gattu.", createdAt: '2026-04-17', updatedAt: '2026-04-17' },
];
