      ...
      `}>
        ...
        <div className="flex items-center justify-between px-4 py-4 border-b border-brand-800">
          <div className="flex items-center gap-3 min-w-0">
            {/* App icon — matches Annu HRBP logo */}
            <div className="flex-shrink-0 w-11 h-11 rounded-xl shadow-lg overflow-hidden bg-white">
              <svg viewBox="0 0 44 44" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
                {/* Navy bold A */}
                <text x="22" y="35" fontFamily="Georgia,serif" fontWeight="900" fontSize="32" fill="#1e3a8a" textAnchor="middle">A</text>
                {/* Gold swoosh replacing crossbar */}
                <path d="M8 27 Q22 19 36 25" stroke="#C9A227" strokeWidth="2.5" fill="none" strokeLinecap="round"/>
              </svg>
            </div>
            <div className="min-w-0">
              <h1 className="text-base font-bold leading-tight text-white">Annu</h1>
              <p className="text-[10px] text-brand-400 font-semibold tracking-widest uppercase">HRBP</p>
            </div>
          </div>
